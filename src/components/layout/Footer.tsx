        ...
        <Box className="flex flex-col lg:flex-row justify-between items-start gap-12 lg:gap-16">
          ...
          <Box className="flex-1 min-w-0 lg:max-w-xs">
            ...
            <Box className="flex gap-4">
              <IconButton
                size="large"
                className="hover:bg-gradient-to-r hover:from-gray-600 hover:to-gray-600 !bg-gradient-to-tr from-yellow-400 via-[#e1306c] to-[#405de6] !text-white transform hover:scale-110 transition-transform"
              ...
              <IconButton
                size="large"
                className="hover:!bg-gray-600 !bg-red-500 !text-white transform hover:scale-110 transition-transform"
